            ...
            <div class="wizard wizard-1" id="kt_contact_add" data-wizard-state="step-first" data-wizard-clickable="true">
                ...
                <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                    <div class="col-xl-12 col-xxl-7">
                        ...
                        <form id="TypeValidation" class="form-horizontal" action="{{ route('driver-category.store') }}"
                            method="post">
                            @csrf
                            <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                <h3 class="mb-10 font-weight-bold text-dark">Add Category Driver</h3>
                                <div class="row">
                                    <div class="col-xl-12">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="col-md-12">
                        <form id="TypeValidation" class="form-horizontal" action="{{ route('driver-category.store')}}" method="post">
                            @csrf
                            <div class="card-content">
                                <div class="row">
