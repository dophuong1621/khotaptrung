            ...
            <div class="wizard wizard-1" id="kt_contact_add" data-wizard-state="step-first" data-wizard-clickable="true">
                ...
                <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                    <div class="col-xl-12 col-xxl-7">
                        ...
                        <form method="POST" action="{{ route('driver-item.update',$driver->id) }}">
                            @method('PUT')
                            @csrf
                            <!--begin::Form Wizard Step 1-->
                            <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                <h3 class="mb-10 font-weight-bold text-dark">Edit Item Driver</h3>
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <input class="form-control form-control-lg form-control-solid"
                                                    name="title" type="text" value="{{ $driver->title }}" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <select name="status" class="form-control">
                                                    <option value="1"
                                                        @if ($driver->status == 1) selected @endif>Active
                                                    </option>
                                                    <option value="0"
                                                        @if ($driver->status == 0) selected @endif>In-Active
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
