...
<div class="card card-custom">
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        <div class="card-title">
            <i class="text-dark-50 la socicon-overwatch" style="margin-right: 10px;"></i>
            <span><h3 class="card-label">Driver Item</h3></span>
        </div>
    ...
    <div class="card-body">
        ...
        <div class="mb-7">
            ...
            <div class="card-toolbar" style="position: absolute;right: 0px;padding: 25px;">
                <!--begin::Button-->
                <a href="{{ route('driver-item.create') }}" class="btn btn-primary font-weight-bolder">
                ...
                <tr @foreach ($driver as $d)>
                    ...
                    <td>
                        <div class="td-actions text-center" style=" display: flex; justify-content: space-evenly;">
                            <a rel="tooltip" href="{{ route('driver-item.edit', $d->id) }}" data-original-title="Edit">
                                <i class="flaticon2-pen ki text-primary"></i>
                            </a>
                            <form method="post" action="{{route('driver-item.destroy',$d->id)}}">
                                @method('delete')
                                @csrf
            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="text-right">
                        <a rel="tooltip" title="" class="btn btn-primary" href="{{ route('driver-item.create') }}" data-original-title="Create">
                                ...
                                <tr @foreach ($driver as $d)>
                                    ...
                                    <td>
                                        <div class="td-actions text-center" style=" display: flex; justify-content: center;">
                                            <a rel="tooltip" class="btn btn-info btn-simple" href="{{ route('driver-item.edit', $d->id) }}">
