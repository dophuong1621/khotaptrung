                            ...
                            <div class="mt-3 ct-nt">
                                <div class="text-sm fw-6">
                                    <p>
                                        ...
                                        </span> Hệ thống nạp <b class="t-color">ATM/MOMO tự động 24/24</b>, Nạp 100k
                                        nhận
                                        110k tiền shop
                                    </p>
                                    <p>
                                ...
                                <div>
                                    ...
                                    <div class="my-2">
                                        ...
                                        <div class="mt-2 fw-6 text-sm">
                                            <i class="ml-075 bx bxs-upvote"></i> Khi chuyển khoản qua Ngân hàng (ATM)
                                            bạn
                                            cần ghi nội dung
...
<div class="popup-home" style="z-index: 1002;display:none">
    <div class="modal-home" style="margin-top:15vh;">
        <div class="tb-home">
...
{{-- popup-login --}}
<div class="popup-login" style="z-index: 1005;display:none;">
    <div class="modal-login" style="margin-top: 15vh;">
        ...
        <div class="login-body">
            <div class="w-100">
                ...
                <div class="mb-3 error-login">
                    @if (session('error'))
                        <div class="t-color fw-6 text-sm py-2 px-3 bg-color br-025 w-100 d-block bor-1-red">
                            {{ session('error') }}
                        </div>
                    @endif
                </div>
                <button class="border-w-1 bg-blue br-025 h-275r px-075 fw-6 w-100 bor-col-blue text-white"
                    style="border: 0px;">
                    <span class="ml-2r position-relative">
                        <i class="position-absolute bx bxl-facebook-circle text-2xl"
                            style="top: -3px; left: -30px;"></i>
                        Đăng nhập bằng Facebook
                    </span>
                </button>
                <div class="mt-125r sigin">
                    <form action="{{ route('login') }}" method="POST" enctype="multipart/form-data"
                        id="form_login" name="csrf-token" content="{{ csrf_token() }}">
                        @csrf
                        <div class="mt-2 mb-075">
                            <label class="d-block fw-6 text-sm text-blue">
                                Tài khoản *
                            </label>
                            <input class="w-100 border-1 bor-col-blue br-025 h-275r px-075 fw-6" name="username"
                                id="username">
                        </div>
                        <div class="mb-075">
                            <label class="d-block fw-6 text-sm text-blue">
                            ...
                            <input type="password" class="w-100 border-1 bor-col-blue br-025 h-275r px-075 fw-6"
                                name="password" id="password">
                        </div>
                        <div class="text-end mb-2 text-blue text-sm fw-6">
                            <a> Quên mật khẩu </a>
                        </div>
                        <button type="submit"
                            class="border-1 t-color br-025 h-275r px-075 fw-6 w-100 dx text-white mb-075">
                            <span class="position-relative"> ĐĂNG NHẬP </span>
                        </button>
                        <button type="button"
                            class="border-1 border-gray br-025 h-275r px-075 fw-6 w-100 bg-box text-gray ct-regis">
                            <span class="position-relative"> Tạo tài khoản </span>
                        </button>
                    </form>
                </div>
                <div class="mt-125r sigup" style="display: none;">
                    <form action="{{ route('register') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mt-2 mb-075 d-grid grid-temp-col-12 gap-2">
                            <div class="gc-7">
                                <label class="d-block fw-6 text-sm text-blue">
                                    Tên tài khoản *
                                </label>
                                <input name="username" type="text"
                                    class="w-100 border-w-1 bor-1-col-blue br-025 h-275r px-075 fw-6">
                            </div>
                            <div class="gc-5">
                                <label class="d-block fw-6 text-sm text-blue">
                                    Số điện thoại *
                        ...
                        <div class="mb-075">
                            ...
                            <input type="password" class="w-100 border-w-1 bor-1-col-blue br-025 h-275r px-075 fw-6">
                        </div>
                        <button type="submit"
                            class="border-1 t-color br-025 h-275r px-075 fw-6 w-100 dx text-white mb-075">
                        ...
                        <button type="button"
                            class="border-1 border-gray br-025 h-275r px-075 fw-6 w-100 bg-box text-gray ct-login">
                            <span class="position-relative"> Đăng nhập </span>
                        </button>
                    </form>
                </div>
