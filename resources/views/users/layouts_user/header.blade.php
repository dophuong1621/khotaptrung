    ...
    <nav class="m-width">
        <div class="container-h">
            <div class="header d-flex">
                <div class="h-left d-flex flex-item-cent">
                    ...
                    <a href="recharge"
                        ...
                        <span
                            ...
                            <i class="text-lg bx bx-dollar"></i>
                        </span>
                        NẠP THẺ
                    </a>
                    <a
                ...
                <div class="d-flex flex-wrap align-items-center h-login">
                    <div class="noti">
                        <a href="/notification"
                    ...
                    <div class="">
                        <span class="drop-d">
                            ...
                            <span class="el-popover__reference-wrapper hehe">
                                <button
                ...
                @else
                <div class="h-right d-flex btn-loginn">
