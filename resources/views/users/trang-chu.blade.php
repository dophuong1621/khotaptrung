                        ...
                        <div class="nt-top overflow-auto mb-3">
                            <div class="px-2 d-flex justify-content-between mb-2">
                                ...
                                <div class="topr text-white">
                                    <span class="t-nub fw-7"> 2,200,000
                                        <span class="d-nub">đ</span>
                                    </span>
                                </div>
                            </div>
                            <div class="px-2 d-flex justify-content-between mb-2">
                                ...
                                <div class="topr text-white">
                                    <span class="t-nub fw-7"> 1,820,000
                                        <span class="d-nub">đ</span>
                                    </span>
                                </div>
                            </div>
                            <div class="px-2 d-flex justify-content-between mb-2">
                                ...
                                <div class="topr text-white">
                                    <span class="t-nub fw-7"> 1,600,000
                                        <span class="d-nub">đ</span>
                                    </span>
                                </div>
                            </div>
                            <div class="px-2 d-flex justify-content-between mb-2">
                                ...
                                <div class="topr text-white">
                                    <span class="t-nub fw-7"> 1,400,000
                                        <span class="d-nub">đ</span>
                                    </span>
                                </div>
                            </div>
                            <div class="px-2 d-flex justify-content-between mb-2">
                                ...
                                <div class="topr text-white">
                                    <span class="t-nub fw-7"> 1,360,000
                                        <span class="d-nub">đ</span>
                                    </span>
                                </div>
                            </div>
